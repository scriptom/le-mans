CREATE OR REPLACE FUNCTION public.reporte_cuatro_data(
    ...
    RETURNS TABLE
            (
                ...
                equipo_nacionalidad                varchar,
                auto_categoria                     varchar,
                auto_foto                          varchar,
                auto_modelo                        varchar,
                auto_fabricante                    varchar,
                auto_hibrido                       char,
                auto_motor                         varchar,
                auto_fabricante_cauchos            varchar,
                ...
                diferencia_puesto_anterior_tiempo  interval,
                diferencia_puesto_anterior_vueltas integer
            )
    LANGUAGE 'plpgsql'
    COST 100
...
BEGIN
    ...
    IF inp_ano is NULL THEN
        ...
        FOR var_participaciones IN
            (
                select f.ano                                 as ano,
                       pa.numero_participacion               as numero_equipo,
                       e.nombre                              as equipo_nombre,
                       e.nacionalidad                        as equipo_nacionalidad,
                       v.categoria                           as auto_categoria,
                       encode(v.foto::bytea, 'hex')          as auto_foto,
                       v.nombre                              as auto_modelo,
                       pa.puesto_final                       as puesto_final,
                       v.fabricante                          as auto_fabricante,
                       v.hibrido                             as auto_hibrido,
                       v.fabricante_caucho                   as auto_fabricante_cauchos,
                       v.motor                               as auto_motor,
                       pi1.id                                as id_piloto1,
                       pi1.nombre                            as piloto_nombre1,
                       ...
                       pi2.id                                as id_piloto2,
                       pi2.nombre                            as piloto_nombre2,
                       pi2.pais_origen                       as piloto_pais2,
                       encode(pi2.foto_pais::bytea, 'hex')   as piloto_foto_pais2,
                       encode(pi2.foto::bytea, 'hex')        as piloto_foto2,
                       pi3.id                                as id_piloto3,
                       pi3.nombre                            as piloto_nombre3,
                       pi3.pais_origen                       as piloto_pais3,
                       encode(pi3.foto_pais::bytea, 'hex')   as piloto_foto_pais3,
                       encode(pi3.foto::bytea, 'hex')        as piloto_foto3,

                       pa.cantidad_vueltas                   as cantidad_vueltas,
                       pa.distancia_recorrida                as distancia_recorrida,
                       pa.velocidad_media                    as velocidad_media,
                ...
                from d_equipo as e,
                     d_fecha as f,
                     d_vehiculo as v,
                     h_participacion as pa,
                     d_piloto as pi1,
                     d_piloto as pi2,
                     d_piloto as pi3

                where pa.id_piloto1 = pi1.id
                  and pa.id_piloto2 = pi2.id
                  and pa.id_piloto3 = pi3.id
