...
CREATE TABLE "d_piloto" (
  ...
  "foto" bytea NOT NULL,
  "pais_origen" char varying(25) NOT NULL,
  "nacionalidad" char varying(25) NOT NULL,
...
CREATE TABLE "d_equipo" (
  "id" int NOT NULL,
  "nombre" char varying(40) NOT NULL,
  "pais_origen" char varying(40) NOT NULL,
  "nacionalidad" char varying(40) NOT NULL
);
