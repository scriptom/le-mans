...
class ReportediezController extends Controller
{
    public function consultar()
    {
        $anos= DB::SELECT("select * from consultar_anos()");
        return view('reportediez.consultar')
            ->with('anos',$anos);
    }
    ...
    public function resultados(Request $request)
    {
        ...
        $data= DB::SELECT("select * from reporte_diez_data(?)", [$ano]);
        // dd($data);
...
//   dd($data);
        return view('reportediez.resultados')
            ->with('data',$data);
